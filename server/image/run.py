...
os.environ['TS_TRANSPILE_ONLY'] = 'true'  # assume typescript code isn't broken
...
def start_hub():
    run(". smc-env && hub start \
            ...
            --proxy_port 5001 \
            --share_port 5002 \
            --share_path='/projects/home/[project_id]' \
            --update \
            --kubernetes \
...
def start_compute():
    ...
    run(". smc-env; compute --host=localhost --kubernetes start 1>/var/log/compute.log 2>/var/log/compute.err &",
        path='/cocalc/src')
